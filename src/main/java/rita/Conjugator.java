...
public class Conjugator {
	...
	public static final String[] IRREG_VERBS_LEX = {
			...
			"overstepping", "overstep", "oversold", "oversell", "overtaken", "overtake", "overthrew", "overthrow", "overthrown", "overthrow", "overtook", "overtake", "pacified",
			...
			"remit", "repaid", "repay", "repelled", "repel", "repelling", "repel", "replied", "reply", "resetting", "reset", "resold", "resell", "retaken", "retake",
	...
	private static final String[] IRREG_PAST_PART = { "done", "gone", "abode", "been", "begotten", "begun", "bent", "bid",
			...
			"met", "mown", "paid", "pled", "relaid", "rung", "said", "sat", "sent", "shod", "shot", "slain",

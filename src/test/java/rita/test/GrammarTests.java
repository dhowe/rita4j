...
public class GrammarTests {
	...
	public void testConstructor() {
		RiGrammar gr = new RiGrammar();
		assertTrue(gr instanceof RiGrammar);
	}
	...
	public void testSetRules() {
		...
		assertTrue(rg.rules["start"] != null);
		assertTrue(rg.rules["noun_phrase"] != null);
	...
	public void testExpandFromWeights() {
       RiGrammar rg = new RiGrammar();
        ...
        assertTrue(rg.expand("$mammal"), "dog");
	...
	public void testCustomTransform() {
     ...
     RiGrammar rg = new RiTa.Grammar(rules, context);
     assertEquals(rg.expand(), "My jobArea jobType.");
	}

	@Test
	public void testSymbolTransfrom() {
    RiGrammar rg = new RiGrammar("{\"start\": \"$tmpl\",\"tmpl\": \"$jrSr.capitalize()\",\"jrSr\": \"(junior|junior)\"}");
        assertEquals(rg.expand(opts("trace", false)), "Junior");

    RiGrammar rg = new RiGrammar("{\"start\": \"$r.capitalize()\",\"r\": \"(a|a)\"}");
        assertEquals(rg.expand(opts("trace", false)), "A");
